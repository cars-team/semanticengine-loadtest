...
class LoaderBehavior(TaskSet):
	...
	#tasks = { listAll }
	tasks = { observation_temp: 3, observation_hum: 1 }
...
class SemanticEngineLoader(HttpLocust):
	...
	host = "http://" + res['ENGINE_IP_ADDR'] + ":" + res['ENGINE_API_PORT'] + "/engineapi"
	
	min_wait = res['LOCUST_MIN_WAIT']
	max_wait = res['LOCUST_MAX_WAIT']
